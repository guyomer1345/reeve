...
serving/format + sandbox-CSP isolation · refine-round cap · on-disk location)**; commitment-status storage +
the rest of cluster E still open. `init` follow-ons: brownfield
